...
Public Class CryPagosProyectos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryPagosProyectos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPagosProyectos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPagosProyectos = New CryPagosProyectos()
        rpt.Site = Me.Site
        Return rpt
    End Function
