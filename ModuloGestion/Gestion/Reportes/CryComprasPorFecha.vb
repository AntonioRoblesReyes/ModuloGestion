...
Public Class CryComprasPorFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryComprasPorFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryComprasPorFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryComprasPorFecha = New CryComprasPorFecha()
        rpt.Site = Me.Site
        Return rpt
    End Function
