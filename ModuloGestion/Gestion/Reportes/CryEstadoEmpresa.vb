...
Public Class CryEstadoEmpresa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryEstadoEmpresa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryEstadoEmpresa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryEstadoEmpresa = New CryEstadoEmpresa()
        rpt.Site = Me.Site
        Return rpt
    End Function
