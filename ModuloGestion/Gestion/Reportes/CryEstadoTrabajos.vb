...
Public Class CryEstadoTrabajos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryEstadoTrabajos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryEstadoTrabajos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryEstadoTrabajos = New CryEstadoTrabajos()
        rpt.Site = Me.Site
        Return rpt
    End Function
