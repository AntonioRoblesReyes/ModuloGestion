...
Public Class CryAnalisisPres
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryAnalisisPres.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryAnalisisPres
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryAnalisisPres = New CryAnalisisPres()
        rpt.Site = Me.Site
        Return rpt
    End Function
