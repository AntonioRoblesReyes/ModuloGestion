...
Public Class CryCobrosDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryCobrosDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryCobrosDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryCobrosDetalle = New CryCobrosDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
