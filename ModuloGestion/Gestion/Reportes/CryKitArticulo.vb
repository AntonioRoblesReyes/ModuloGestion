...
Public Class CryKitArticulo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryKitArticulo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryKitArticulo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryKitArticulo = New CryKitArticulo()
        rpt.Site = Me.Site
        Return rpt
    End Function
