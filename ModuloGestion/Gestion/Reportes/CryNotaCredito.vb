...
Public Class CryNotaCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryNotaCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ComprobanteAfectado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCryNotaCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryNotaCredito = New CryNotaCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
