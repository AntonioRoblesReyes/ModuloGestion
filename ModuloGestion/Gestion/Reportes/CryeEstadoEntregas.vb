...
Public Class CryeEstadoEntregas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryeEstadoEntregas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryeEstadoEntregas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryeEstadoEntregas = New CryeEstadoEntregas()
        rpt.Site = Me.Site
        Return rpt
    End Function
