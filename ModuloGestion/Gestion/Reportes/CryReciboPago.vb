...
Public Class CryReciboPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryReciboPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryReciboPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryReciboPago = New CryReciboPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
