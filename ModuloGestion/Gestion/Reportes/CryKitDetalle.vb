...
Public Class CryKitDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryKitDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryKitDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryKitDetalle = New CryKitDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
