...
Public Class CrypresupuestoPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CrypresupuestoPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrypresupuestoPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrypresupuestoPago = New CrypresupuestoPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
