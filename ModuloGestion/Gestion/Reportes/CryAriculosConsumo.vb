...
Public Class CryAriculosConsumo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryAriculosConsumo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryAriculosConsumo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryAriculosConsumo = New CryAriculosConsumo()
        rpt.Site = Me.Site
        Return rpt
    End Function
