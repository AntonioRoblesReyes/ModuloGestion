    ...
    Sub VerificarArticulosDetalle()
        Try
            ...
            If Contar <> 0 Then
                ...
                Try
                    If EstaAbierto(FrmArticulo) AndAlso Not My.Forms.FrmArticulo.IsDisposed AndAlso My.Forms.FrmArticulo.Visible AndAlso My.Forms.FrmArticulo.Created Then
                        If My.Forms.FrmArticulo.TxtIdArticulo.Text <> "" Then
