...
Public Class CryHabitaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryHabitaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryHabitaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryHabitaciones = New CryHabitaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
