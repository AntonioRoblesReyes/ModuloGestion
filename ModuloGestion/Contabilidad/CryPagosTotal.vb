...
Public Class CryPagosTotal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryPagosTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPagosTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPagosTotal = New CryPagosTotal()
        rpt.Site = Me.Site
        Return rpt
    End Function
