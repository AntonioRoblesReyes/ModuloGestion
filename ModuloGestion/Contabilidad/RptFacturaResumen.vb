...
Public Class RptFacturaResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.RptFacturaResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturaResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturaResumen = New RptFacturaResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
