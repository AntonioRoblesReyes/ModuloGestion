...
Public Class CryContratos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryContratos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryContratos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryContratos = New CryContratos()
        rpt.Site = Me.Site
        Return rpt
    End Function
