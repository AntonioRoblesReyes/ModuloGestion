...
Public Class CryReciboAvance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryReciboAvance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryReciboAvance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryReciboAvance = New CryReciboAvance()
        rpt.Site = Me.Site
        Return rpt
    End Function
