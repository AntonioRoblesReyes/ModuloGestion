...
Public Class CryNominaCompleta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryNominaCompleta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryNominaCompleta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryNominaCompleta = New CryNominaCompleta()
        rpt.Site = Me.Site
        Return rpt
    End Function
