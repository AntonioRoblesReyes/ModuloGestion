...
Public Class CryreciboExtras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryreciboExtras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryreciboExtras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryreciboExtras = New CryreciboExtras()
        rpt.Site = Me.Site
        Return rpt
    End Function
