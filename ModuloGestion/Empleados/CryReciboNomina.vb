...
Public Class CryReciboNomina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryReciboNomina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryReciboNomina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryReciboNomina = New CryReciboNomina()
        rpt.Site = Me.Site
        Return rpt
    End Function
