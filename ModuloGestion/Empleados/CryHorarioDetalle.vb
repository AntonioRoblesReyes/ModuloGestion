...
Public Class CryHorarioDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryHorarioDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryHorarioDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryHorarioDetalle = New CryHorarioDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
