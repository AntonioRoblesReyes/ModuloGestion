...
Public Class CrysResumenPagos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CrysResumenPagos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysResumenPagos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysResumenPagos = New CrysResumenPagos()
        rpt.Site = Me.Site
        Return rpt
    End Function
