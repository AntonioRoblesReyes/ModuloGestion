...
Public Class CryResumenFacturas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryResumenFacturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryResumenFacturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryResumenFacturas = New CryResumenFacturas()
        rpt.Site = Me.Site
        Return rpt
    End Function
