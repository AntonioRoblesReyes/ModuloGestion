...
Public Class CryFacturaIns
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryFacturaIns.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryFacturaIns
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryFacturaIns = New CryFacturaIns()
        rpt.Site = Me.Site
        Return rpt
    End Function
