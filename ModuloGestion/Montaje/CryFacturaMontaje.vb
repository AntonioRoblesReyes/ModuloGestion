...
Public Class CryFacturaMontaje
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ModuloGestion.CryFacturaMontaje.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryFacturaMontaje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryFacturaMontaje = New CryFacturaMontaje()
        rpt.Site = Me.Site
        Return rpt
    End Function
